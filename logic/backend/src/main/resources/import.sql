...
insert into BOASTUSER (CREATEDON, USERID, USERNAME, EMAIL)
VALUES (current_timestamp, 125, 'D.Steiner', 'dietmar.steiner@gmail.com');

insert into BOASTUSER (CREATEDON, USERID, USERNAME, EMAIL)
VALUES (current_timestamp, 126, 'C.Aberger', 'christian.aberger@gmail.com');

insert into BOASTUSER (CREATEDON, USERID, USERNAME, EMAIL)
VALUES (current_timestamp, 127, 'M.Huemer', 'martin.huemer@gmail.com');
